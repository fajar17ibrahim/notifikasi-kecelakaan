...
public class PermissionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ContextCompat.checkSelfPermission(PermissionActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            Intent map = new Intent(PermissionActivity.this, MainActivity.class);
            startActivity(map);
            finish();
            return;
        }
                        ...
                        .withListener(new PermissionListener() {
                            ...
                            public void onPermissionDenied(PermissionDeniedResponse response) {
                                if(response.isPermanentlyDenied()) {
                                    ...
                                    builder.setTitle("Izin Ditolak")
                                            .setMessage("Izin akses lokasi ditolak")
                                    ...
                                    Toast.makeText(PermissionActivity.this, "Izin Ditolak", Toast.LENGTH_SHORT).show();
                                }
